...
<form method="POST" action='?module=sewagudangexasosiasi'>
  <table>
	<tr>
    	<td align="center" colspan="2"><b>EXPORT ASOSIASI</b></td>
    </tr>
    ...
    <tr>
    	<td>Minimal Berat</td>
        <td> : <input type="text" name="minweight" size="10" value="<?php echo $p['minweight']; ?>" onkeypress="return isNumberKey(event)"> 
         KG ( min 1 )</td>
    </tr>		

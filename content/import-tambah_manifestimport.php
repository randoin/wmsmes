...
<h2>Tambah Manifest Import</h2>
	<form name="form1" method="POST" action="aksi.php?module=manifestimport&act=tambah" onSubmit="return checkrequired(this)">
	<table>
		<tr>
        	<td>FLIGHT DATE</td>

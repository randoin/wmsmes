<?php
$r=mysql_fetch_array(mysql_query("select * from origin where idorigin='$_GET[id]'"));
  echo "<h2>EDIT DATA origin</h2>
        <form method=POST action='aksi.php?module=dataorigin&act=edit' 
		onSubmit=\"return checkrequired(this)\">
        <table>
       <tr><td>CODE</td>     <td> : <input type=text name=requiredcode
		onChange=\"javascript:this.value=this.value.toUpperCase();\" value='$r[origin_code]' 
